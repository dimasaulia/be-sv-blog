...
import (
	...
	"github.com/sv-blog/internal/modules/releasenotes/dto"
	"github.com/sv-blog/internal/modules/releasenotes/repositories"
	"github.com/sv-blog/internal/modules/releasenotes/services"
...
func (c *ReleaseNoteControllerImpl) Find(w http.ResponseWriter, r *http.Request) {
	...
	releaseNotes, err := c.ReleaseNoteService.Find(r.Context(), limit, offset)
	if err != nil {
		end(err)
